...
public class WeaponEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        weapon.enemyImpactSoundNoDamage = EditorGUILayout.TextField("Enemy Impact Sound No Damage", weapon.enemyImpactSoundNoDamage);
        weapon.friendlyImpactSound = EditorGUILayout.TextField("Friendly Impact Sound", weapon.friendlyImpactSound);
        weapon.damageType = (Weapon.DamageType)EditorGUILayout.EnumPopup("Weapon Type", weapon.damageType);
        EditorGUILayout.Space();
        GUILayout.EndVertical();
